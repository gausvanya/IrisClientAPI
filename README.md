...
# Возможности библиботеки:
  ...
  - Получение информации о аккаунте пользователя (дата первого появления во вселенной ириса, активность в чатах ириса, наличие в спам-базах ириса, валюты в мешке пользователя).
  - Перевод голд, ирисок, очков доната и NFT между ботом и пользователям.
